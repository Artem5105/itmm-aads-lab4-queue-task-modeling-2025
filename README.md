# Алгоритмы и структуры данных: Имитационное моделирование системы обслуживания потока заданий на ЭВМ

## Цели и задачи

В рамках лабораторной работы ставится задача разработки системы имитации однопроцессорной ЭВМ:
 - Имитация генерация задачи
 - Имитация решения задачи
 - Оценка эффективности работы ЭВМ
...
Перед выполнением работы студенты получают данный проект-шаблон, содержащий следующее:
 ...
 - Интерфейсы классов `TQueue` и `TComputeCenterModel` (h-файл).
 - Набор заготовок тестов для каждого из указанных классов.
 - Тестовый пример использования класса `TComputeCenterModel`.

Выполнение работы предполагает решение следующих задач:

  1. Реализация методов шаблонного класса `TQueue` согласно заданному интерфейсу.
  1. Реализация методов класса `TComputeCenterModel` согласно заданному интерфейсу.
  1. Реализация тестов, покрывающих все методы классов `TQueue` и `TComputeCenterModel`.
